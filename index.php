            ...
            <div class="col-sm-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="painel.php" class="btn btn-primary">Acessar</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col col-lg-4 col-sm-4 mb-3">
                <div class="card bg-dark p-3">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <a href="../boot/proprietarios.php" class="text-decoration-none font-serif text-uppercase text-white stretched-link">Proprietários</a>
                    </div>
                </div>
            </div>
            <div class="col col-lg-4 col-sm-4 mb-3">
                <div class="card bg-dark p-3">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <a href="veiculos.php" class="text-decoration-none font-serif text-uppercase text-white stretched-link">Veículos</a>
                    </div>
                </div>
            </div>
        </div>
